...
def amnesty_scrape_func():

    organisation_to_scrape = 'amnesty'
    ...
    followers = browser.find_element_by_xpath("//*[@id='mount_0_0']/div/div[1]/div[1]/div[3]/div/div/div[1]/div[1]/div[4]/div[2]/div/div[1]/div[2]/div[1]/div/div/div/div[2]/div[4]/div/div/div/div[2]/div/div/span").text
    ...
    # NEED TO TURN 5.5K TO 5500
    # for i in likes_per_post:
    #     if i[-1] == "K":
